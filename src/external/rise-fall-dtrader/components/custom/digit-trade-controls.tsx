...
import type { DurationLimits, ProposalInfo, BuyResult } from '@/external/deriv-core';
import type { ContractMode, TradeType } from '@/external/rise-fall-dtrader/lib/digit-types';
