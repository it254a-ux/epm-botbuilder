...
import {
  ...
  TableHeader,
  TableRow,
} from '@/external/rise-fall-dtrader/components/ui/table';
...
import { cn } from '@/external/rise-fall-dtrader/lib/utils';
...
import type { OpenPosition } from '@/external/rise-fall-dtrader/hooks/use-open-positions';
import type { ClosedPosition } from '@/external/rise-fall-dtrader/hooks/use-closed-positions';
